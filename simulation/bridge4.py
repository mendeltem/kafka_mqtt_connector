...
def sensor_loop():
    ...
    message_dict = {
      'device-uuid' : 'DEVICE1-8A12-4F4F-8F69-6B8F3C2E78GG',
      'location' : 'building1/room7',
      'sensors' : [
        {'mqtt-topic' : 'sensor/illuminance/bright4/DEVICE1-8A12-4F4F-8F69-6B8F3C2E78GG',
         'units' : 'lux'},
        {'mqtt-topic' : 'sensor/temperature/temp4/DEVICE1-8A12-4F4F-8F69-6B8F3C2E78GG',
         'units' : 'CelsiusScale'}
      ]
    }
